...
function mlirRegisterAllDialects(context)
    ccall((:mlirRegisterAllDialects, mlir_c), Cvoid, (MlirContext,), context)
end
...
function mlirCreateConversionConvertStandardToLLVM()
    ccall((:mlirCreateConversionConvertStandardToLLVM, mlir_c), MlirPass, ())
end
...
function mlirRegisterConversionConvertStandardToLLVM()
    ccall((:mlirRegisterConversionConvertStandardToLLVM, mlir_c), Cvoid, ())
end
...
function mlirCreateConversionConvertStandardToSPIRV()
    ccall((:mlirCreateConversionConvertStandardToSPIRV, mlir_c), MlirPass, ())
end
...
function mlirRegisterConversionConvertStandardToSPIRV()
    ccall((:mlirRegisterConversionConvertStandardToSPIRV, mlir_c), Cvoid, ())
end
...
function mlirCreateConversionConvertVectorToROCDL()
    ccall((:mlirCreateConversionConvertVectorToROCDL, mlir_c), MlirPass, ())
end
...
function mlirRegisterConversionConvertVectorToROCDL()
    ccall((:mlirRegisterConversionConvertVectorToROCDL, mlir_c), Cvoid, ())
end
...
function mlirCreateConversionSCFToStandard()
    ccall((:mlirCreateConversionSCFToStandard, mlir_c), MlirPass, ())
end
...
function mlirRegisterConversionSCFToStandard()
    ccall((:mlirRegisterConversionSCFToStandard, mlir_c), Cvoid, ())
end
...
function mlirCreateConversionTosaToStandard()
    ccall((:mlirCreateConversionTosaToStandard, mlir_c), MlirPass, ())
end
...
function mlirRegisterConversionTosaToStandard()
    ccall((:mlirRegisterConversionTosaToStandard, mlir_c), Cvoid, ())
end
...
function mlirCreateLinalgLinalgComprehensiveModuleBufferize()
    ccall((:mlirCreateLinalgLinalgComprehensiveModuleBufferize, mlir_c), MlirPass, ())
end

# no prototype is found for this function at Passes.capi.h.inc:26:25, please use with caution
function mlirRegisterLinalgLinalgComprehensiveModuleBufferize()
    ccall((:mlirRegisterLinalgLinalgComprehensiveModuleBufferize, mlir_c), Cvoid, ())
end
...
function mlirCreateLinalgLinalgFoldReshapeOpsByLinearization()
    ccall((:mlirCreateLinalgLinalgFoldReshapeOpsByLinearization, mlir_c), MlirPass, ())
end

# no prototype is found for this function at Passes.capi.h.inc:41:25, please use with caution
function mlirRegisterLinalgLinalgFoldReshapeOpsByLinearization()
    ccall((:mlirRegisterLinalgLinalgFoldReshapeOpsByLinearization, mlir_c), Cvoid, ())
end
...
function mlirCreateLinalgLinalgLowerTiledLoopsToSCF()
    ccall((:mlirCreateLinalgLinalgLowerTiledLoopsToSCF, mlir_c), MlirPass, ())
end

# no prototype is found for this function at Passes.capi.h.inc:61:25, please use with caution
function mlirRegisterLinalgLinalgLowerTiledLoopsToSCF()
    ccall((:mlirRegisterLinalgLinalgLowerTiledLoopsToSCF, mlir_c), Cvoid, ())
end
...
function mlirCreateLinalgLinalgPromotion()
    ccall((:mlirCreateLinalgLinalgPromotion, mlir_c), MlirPass, ())
end

# no prototype is found for this function at Passes.capi.h.inc:86:25, please use with caution
function mlirRegisterLinalgLinalgPromotion()
    ccall((:mlirRegisterLinalgLinalgPromotion, mlir_c), Cvoid, ())
end
...
function mlirCreateLinalgLinalgStrategyPromotePass()
    ccall((:mlirCreateLinalgLinalgStrategyPromotePass, mlir_c), MlirPass, ())
end

# no prototype is found for this function at Passes.capi.h.inc:121:25, please use with caution
function mlirRegisterLinalgLinalgStrategyPromotePass()
    ccall((:mlirRegisterLinalgLinalgStrategyPromotePass, mlir_c), Cvoid, ())
end
...
function mlirGetDialectHandle__std__()
    ccall((:mlirGetDialectHandle__std__, mlir_c), MlirDialectHandle, ())
end
...
function mlirInferTypeOpInterfaceInferReturnTypes(opName, context, location, nOperands, operands, attributes, nRegions, regions, callback, userData)
    ccall((:mlirInferTypeOpInterfaceInferReturnTypes, mlir_c), MlirLogicalResult, (MlirStringRef, MlirContext, MlirLocation, intptr_t, Ptr{MlirValue}, MlirAttribute, intptr_t, Ptr{MlirRegion}, Cint, Ptr{Cvoid}), opName, context, location, nOperands, operands, attributes, nRegions, regions, callback, userData)
end
