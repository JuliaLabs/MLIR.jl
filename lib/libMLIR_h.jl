...
function mlirLocationCallSiteGet(callee, caller)
    ccall((:mlirLocationCallSiteGet, libmlir[]), MlirLocation, (MlirLocation, MlirLocation), callee, caller)
end
...
function mlirNamedAttributeGet(name, attr)
    ccall((:mlirNamedAttributeGet, libmlir[]), MlirNamedAttribute, (MlirIdentifier, MlirAttribute), name, attr)
end
...
function mlirLogicalResultIsSuccess(res)
    ccall((:mlirLogicalResultIsSuccess, libmlir[]), Bool, (MlirLogicalResult,), res)
end

function mlirLogicalResultIsFailure(res)
    ccall((:mlirLogicalResultIsFailure, libmlir[]), Bool, (MlirLogicalResult,), res)
end
