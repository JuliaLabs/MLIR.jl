...
```
"""
function apply_rewrite(args::Vector{Value}; results::Vector{MLIRType}, name, constParams=nothing, location=Location())
...
```
"""
function create_operation(operands::Vector{Value}, attributes::Vector{Value}, types::Vector{Value}; operation::MLIRType, name, attributeNames, location=Location())
    results = MLIRType[operation, ]
...
```
"""
function get_attribute(operation::Value; attribute::MLIRType, name, location=Location())
    results = MLIRType[attribute, ]
    operands = Value[operation, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function get_defining_op(value::Value; operation::MLIRType, location=Location())
    results = MLIRType[operation, ]
    operands = Value[value, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function get_operand(operation::Value; value::MLIRType, index, location=Location())
...
```
"""
function get_operands(operation::Value; value::MLIRType, index=nothing, location=Location())
    results = MLIRType[value, ]
    operands = Value[operation, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function get_result(operation::Value; value::MLIRType, index, location=Location())
    results = MLIRType[value, ]
    operands = Value[operation, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function get_results(operation::Value; value::MLIRType, index=nothing, location=Location())
    results = MLIRType[value, ]
    operands = Value[operation, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function inferred_types(; type::MLIRType, location=Location())
