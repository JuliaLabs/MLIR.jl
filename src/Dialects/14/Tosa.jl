...
"""
function select(input1::Value, input2::Value, input3::Value; output::MLIRType, location=Location())
    results = MLIRType[output, ]
...
weights tensor.
"""
function transpose_conv2d(input::Value, filter::Value, bias::Value; output::MLIRType, out_pad, stride, dilation, out_shape, quantization_info=nothing, location=Location())
    results = MLIRType[output, ]
