...
"""
function vscale(; res::MLIRType, location=Location())
...
```
"""
function extract(vector::Value; result_0::MLIRType, position, location=Location())
    results = MLIRType[result_0, ]
    operands = Value[vector, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function fma(lhs::Value, rhs::Value, acc::Value; result::MLIRType, location=Location())
    results = MLIRType[result, ]
...
```
"""
function insertelement(source::Value, dest::Value, position=nothing::Union{Nothing, Value}; result::MLIRType, location=Location())
    results = MLIRType[result, ]
...
```
"""
function insert_map(vector::Value, dest::Value, ids::Vector{Value}; result::MLIRType, location=Location())
    results = MLIRType[result, ]
...
```
"""
function insert(source::Value, dest::Value; res::MLIRType, position, location=Location())
    results = MLIRType[res, ]
    operands = Value[source, dest, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function insert_strided_slice(source::Value, dest::Value; res::MLIRType, offsets, strides, location=Location())
    results = MLIRType[res, ]
    operands = Value[source, dest, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function multi_reduction(source::Value; dest::MLIRType, kind, reduction_dims, location=Location())
...
```
"""
function reduction(vector::Value, acc::Vector{Value}; dest::MLIRType, kind, location=Location())
    results = MLIRType[dest, ]
...
```
"""
function scan(source::Value, initial_value::Value; dest::MLIRType, accumulated_value::MLIRType, kind, reduction_dim, inclusive, location=Location())
    results = MLIRType[dest, accumulated_value, ]
...
```
"""
function shuffle(v1::Value, v2::Value; vector::MLIRType, mask, location=Location())
    results = MLIRType[vector, ]
