...
```
"""
function abs(complex; result::MLIRType, location=Location())
...
```
"""
function angle(complex; result::MLIRType, location=Location())
    results = MLIRType[result, ]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function conj(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cos(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function create(real, imaginary; complex::MLIRType, location=Location())
    results = MLIRType[complex, ]
...
```
"""
function eq(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function exp(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function expm1(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function im(complex; imaginary::MLIRType, location=Location())
    results = MLIRType[imaginary, ]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
    attributes = NamedAttribute[]
...
```
"""
function log1p(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function neg(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function neq(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function pow(lhs, rhs; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(lhs), get_value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function re(complex; real::MLIRType, location=Location())
    results = MLIRType[real, ]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
    attributes = NamedAttribute[]
...
```
"""
function rsqrt(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sign(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sin(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sqrt(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function tan(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function tanh(complex; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = API.MlirValue[get_value(complex), ]
    owned_regions = Region[]
    successors = Block[]
