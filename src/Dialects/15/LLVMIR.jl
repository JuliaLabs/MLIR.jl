...
```
"""
function call(operand_0; result_0::Vector{MLIRType}, callee=nothing, fastmathFlags=nothing, location=Location())
...
"""
function getelementptr(base, indices; res::MLIRType, structIndices, elem_type=nothing, location=Location())
    results = MLIRType[res, ]
...
"""
function insertelement(vector, value, position; res::MLIRType, location=Location())
    results = MLIRType[res, ]
...
"""
function insertvalue(container, value; res::MLIRType, position, location=Location())
    results = MLIRType[res, ]
...
"""
function invoke(callee_operands, normalDestOperands, unwindDestOperands; result_0::Vector{MLIRType}, callee=nothing, normalDest::Block, unwindDest::Block, location=Location())
    results = MLIRType[result_0..., ]
