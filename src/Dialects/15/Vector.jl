...
```
"""
function extractelement(vector::Value, position=nothing::Union{Nothing, Value}; result::MLIRType, location=Location())
    results = MLIRType[result, ]
...
```
"""
function extract_map(vector::Value, ids::Vector{Value}; result_0::MLIRType, location=Location())
    results = MLIRType[result_0, ]
...
```
"""
function insert_map(vector::Value, dest::Value, ids::Vector{Value}; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
