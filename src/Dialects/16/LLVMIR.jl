...
"""
function alloca(arraySize; res::IR.Type, alignment=nothing, elem_type=nothing, location=Location())
    results = IR.Type[res, ]
...
```
"""
function call(operand_0; result=nothing::Union{Nothing, IR.Type}, callee=nothing, fastmathFlags=nothing, branch_weights=nothing, location=Location())
    results = IR.Type[]
