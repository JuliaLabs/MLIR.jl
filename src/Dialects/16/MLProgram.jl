...
```
"""
function global_load_graph(consumeTokens; result::MLIRType, produceToken::MLIRType, global_, location=Location())
...
```
"""
function global_store_graph(value, consumeTokens; produceToken::MLIRType, global_, location=Location())
