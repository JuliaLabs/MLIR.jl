...
```
"""
function absf(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
...
```
"""
function absi(operand::Value; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function atan(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function cbrt(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function ceil(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function copysign(lhs::Value, rhs::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cos(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function ctlz(operand::Value; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function cttz(operand::Value; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function ctpop(operand::Value; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function erf(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function exp2(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function expm1(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function exp(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function fpowi(lhs::Value, rhs::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function floor(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function fma(a::Value, b::Value, c::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
...
```
"""
function ipowi(lhs::Value, rhs::Value; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log10(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log1p(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log2(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function log(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function powf(lhs::Value, rhs::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[lhs, rhs, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function roundeven(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function round(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function rsqrt(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sin(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function sqrt(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function tan(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function tanh(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function trunc(operand::Value; result=nothing::Union{Nothing, MLIRType}, fastmath=nothing, location=Location())
    results = MLIRType[]
    operands = Value[operand, ]
    owned_regions = Region[]
    successors = Block[]
