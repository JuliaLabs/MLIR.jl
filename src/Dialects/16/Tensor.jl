...
"""
function empty(dynamicSizes::Vector{Value}; result::MLIRType, location=Location())
    results = MLIRType[result, ]
...
```
"""
function extract(tensor::Value, indices::Vector{Value}; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
...
```
"""
function gather(source::Value, indices::Value; result::MLIRType, gather_dims, unique=nothing, location=Location())
    results = MLIRType[result, ]
...
```
"""
function insert(scalar::Value, dest::Value, indices::Vector{Value}; result=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
...
```
"""
function insert_slice(source::Value, dest::Value, offsets::Vector{Value}, sizes::Vector{Value}, strides::Vector{Value}; result=nothing::Union{Nothing, MLIRType}, static_offsets, static_sizes, static_strides, location=Location())
    results = MLIRType[]
...
```
"""
function scatter(source::Value, dest::Value, indices::Value; result::MLIRType, scatter_dims, unique=nothing, location=Location())
    results = MLIRType[result, ]
...
```
"""
function unpack(source::Value, dest::Value, inner_tiles::Vector{Value}; result=nothing::Union{Nothing, MLIRType}, outer_dims_perm=nothing, inner_dims_pos, static_inner_tiles, location=Location())
    results = MLIRType[]
    operands = Value[source, dest, inner_tiles..., ]
    owned_regions = Region[]
    successors = Block[]
