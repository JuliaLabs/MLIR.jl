...
registers.
"""
function avx512_vp2intersect(a::Value, b::Value; k1=nothing::Union{Nothing, MLIRType}, k2=nothing::Union{Nothing, MLIRType}, location=Location())
    results = MLIRType[]
    operands = Value[a, b, ]
    owned_regions = Region[]
    successors = Block[]
    attributes = NamedAttribute[]
    (k1 != nothing) && push!(results, k1)
    (k2 != nothing) && push!(results, k2)
