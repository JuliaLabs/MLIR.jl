...
```
"""
function maxf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[value(lhs), value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
...
```
"""
function minf(lhs, rhs; result=nothing::Union{Nothing, IR.Type}, fastmath=nothing, location=Location())
    results = IR.Type[]
    operands = Value[value(lhs), value(rhs), ]
    owned_regions = Region[]
    successors = Block[]
