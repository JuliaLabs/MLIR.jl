...
function zip_x2(
    ...
    _results = IR.Type[resultV1, resultV2]
    _operands = Value[sourceV1, sourceV2]
    _owned_regions = Region[]
    _successors = Block[]
    _attributes = NamedAttribute[]
...
"""
function intr_zip_x4(
    v1::Value, v2::Value, v3::Value, v4::Value; res::IR.Type, location=Location()
)
    _results = IR.Type[res,]
    _operands = Value[v1, v2, v3, v4]
    _owned_regions = Region[]
    _successors = Block[]
    _attributes = NamedAttribute[]
...
function zip_x4(
    ...
    _results = IR.Type[resultV1, resultV2, resultV3, resultV4]
    _operands = Value[sourceV1, sourceV2, sourceV3, sourceV4]
    _owned_regions = Region[]
    _successors = Block[]
    _attributes = NamedAttribute[]
