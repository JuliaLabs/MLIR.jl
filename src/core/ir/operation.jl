...
get_region(op::Operation, pos::Int) = MLIR.API.mlirOperationGetRegion(unwrap(op), Ptr{Int}(pos))
...
get_operand(op::Operation, pos::Int) = MLIR.API.mlirOperationGetOperand(unwrap(op), Ptr{Int}(pos))
get_num_results(op::Operation) = MLIR.API.mlirOperationGetNumResults(unwrap(op))
get_result(op::Operation, pos::Int) = MLIR.API.mlirOperationGetResult(unwrap(op), Ptr{Int}(pos))
